...
A native macOS menu bar app that turns your speech into clean, formatted text. Hold the **fn** key to record, release to transcribe and format — then it's automatically pasted into whatever you're typing in.

Think [Wispr Flow](https://wispr.com), but open source and DIY.

## How It Works

1. **Hold fn** → starts recording from your microphone
2. **Release fn** → stops recording, sends audio to OpenAI Whisper for transcription
...
- Hold **fn** → mic icon turns red (recording)
- Speak your text
- Release **fn** → icon turns orange (processing) → text is pasted
